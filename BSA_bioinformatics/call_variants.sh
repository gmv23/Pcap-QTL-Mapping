...
#Now filter to get two files: one with just SNPs for BSA, and one with all variants for candidate gene analysis
vcftools --vcf final_geno.vcf --remove-indels --max-alleles 2 --recode --out final_geno_snps
